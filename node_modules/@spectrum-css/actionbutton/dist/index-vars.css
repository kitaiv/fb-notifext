...
.spectrum-ActionButton.focus-ring {
    ...
    box-shadow: 0 0 0 var(--spectrum-actionbutton-m-quiet-textonly-border-size-key-focus, var(--spectrum-alias-border-size-thick)) var(--spectrum-actionbutton-m-textonly-border-color-key-focus, var(--spectrum-alias-component-border-color-key-focus));
...
.spectrum-ActionButton--emphasized {
  background-color: var(--spectrum-actionbutton-m-emphasized-textonly-background-color, var(--spectrum-alias-component-background-color-default));
  border-color: var(--spectrum-actionbutton-m-emphasized-textonly-border-color, var(--spectrum-alias-component-border-color-default));
  color: var(--spectrum-actionbutton-m-emphasized-textonly-text-color, var(--spectrum-alias-component-text-color-default));
}

.spectrum-ActionButton--emphasized .spectrum-Icon {
    color: var(--spectrum-actionbutton-m-emphasized-texticon-icon-color, var(--spectrum-alias-component-icon-color-default));
  }

.spectrum-ActionButton--emphasized .spectrum-ActionButton-hold {
    color: var(--spectrum-actionbutton-m-emphasized-textonly-hold-icon-color, var(--spectrum-alias-component-icon-color-default));
  }

.spectrum-ActionButton--emphasized.is-selected .spectrum-ActionButton-hold {
      color: var(--spectrum-actionbutton-m-emphasized-textonly-hold-icon-color-selected, var(--spectrum-alias-component-icon-color-emphasized-selected-default));
    }
...
.spectrum-ActionButton--emphasized:hover {
    background-color: var(--spectrum-actionbutton-m-emphasized-textonly-background-color-hover, var(--spectrum-alias-component-background-color-hover));
    border-color: var(--spectrum-actionbutton-m-emphasized-textonly-border-color-hover, var(--spectrum-alias-component-border-color-hover));
    box-shadow: none;
    color: var(--spectrum-actionbutton-m-emphasized-textonly-text-color-hover, var(--spectrum-alias-component-text-color-hover));
  }

.spectrum-ActionButton--emphasized:hover .spectrum-Icon {
      color: var(--spectrum-actionbutton-m-emphasized-texticon-icon-color-hover, var(--spectrum-alias-component-icon-color-hover));
    }

.spectrum-ActionButton--emphasized:hover .spectrum-ActionButton-hold {
      color: var(--spectrum-actionbutton-m-emphasized-textonly-hold-icon-color-hover, var(--spectrum-alias-component-icon-color-hover));
    }

.spectrum-ActionButton--emphasized.focus-ring {
    background-color: var(--spectrum-actionbutton-m-emphasized-textonly-background-color-key-focus, var(--spectrum-alias-component-background-color-key-focus));
    border-color: var(--spectrum-actionbutton-m-emphasized-textonly-border-color-key-focus, var(--spectrum-alias-component-border-color-key-focus));
    box-shadow: 0 0 0 var(--spectrum-actionbutton-m-quiet-textonly-border-size-key-focus, var(--spectrum-alias-border-size-thick)) var(--spectrum-actionbutton-m-textonly-border-color-key-focus, var(--spectrum-alias-component-border-color-key-focus));
    color: var(--spectrum-actionbutton-m-emphasized-textonly-text-color-key-focus, var(--spectrum-alias-component-text-color-key-focus));
  }

.spectrum-ActionButton--emphasized.focus-ring .spectrum-Icon {
      color: var(--spectrum-actionbutton-m-emphasized-texticon-icon-color-key-focus, var(--spectrum-alias-component-icon-color-key-focus));
    }

.spectrum-ActionButton--emphasized.focus-ring .spectrum-ActionButton-hold {
      color: var(--spectrum-actionbutton-m-emphasized-textonly-hold-icon-color-key-focus, var(--spectrum-alias-component-icon-color-key-focus));
    }

.spectrum-ActionButton--emphasized.is-active {
    background-color: var(--spectrum-actionbutton-m-emphasized-textonly-background-color-down, var(--spectrum-alias-component-background-color-down));
    border-color: var(--spectrum-actionbutton-m-emphasized-textonly-border-color-down, var(--spectrum-alias-component-border-color-down));
    box-shadow: none;
    color: var(--spectrum-actionbutton-m-emphasized-textonly-text-color-down, var(--spectrum-alias-component-text-color-down));
  }

.spectrum-ActionButton--emphasized.is-active .spectrum-ActionButton-hold {
      color: var(--spectrum-actionbutton-m-emphasized-textonly-hold-icon-color-down, var(--spectrum-alias-component-icon-color-down));
    }

.spectrum-ActionButton--emphasized:disabled,
  .spectrum-ActionButton--emphasized.is-disabled {
    background-color: var(--spectrum-actionbutton-m-emphasized-textonly-background-color-disabled, var(--spectrum-alias-component-background-color-disabled));
    border-color: var(--spectrum-actionbutton-m-emphasized-textonly-border-color-disabled, var(--spectrum-alias-component-border-color-disabled));
    color: var(--spectrum-actionbutton-m-emphasized-textonly-text-color-disabled, var(--spectrum-alias-component-text-color-disabled));
  }

.spectrum-ActionButton--emphasized:disabled .spectrum-Icon, .spectrum-ActionButton--emphasized.is-disabled .spectrum-Icon {
      color: var(--spectrum-actionbutton-m-emphasized-texticon-icon-color-disabled, var(--spectrum-alias-component-icon-color-disabled));
    }
...
.spectrum-ActionButton--emphasized:disabled .spectrum-ActionButton-hold, .spectrum-ActionButton--emphasized.is-disabled .spectrum-ActionButton-hold {
      color: var(--spectrum-actionbutton-m-emphasized-textonly-hold-icon-color-disabled, var(--spectrum-alias-component-icon-color-disabled));
    }
...
.spectrum-ActionButton--quiet.focus-ring {
    ...
    box-shadow: 0 0 0 var(--spectrum-actionbutton-m-quiet-textonly-border-size-key-focus, var(--spectrum-alias-border-size-thick)) var(--spectrum-actionbutton-m-quiet-textonly-border-color-key-focus, var(--spectrum-alias-component-border-color-quiet-key-focus));
...
@media (forced-colors: active) {
  .spectrum-ActionButton {
    --spectrum-actionbutton-m-emphasized-texticon-icon-color: ButtonText;
    --spectrum-actionbutton-m-emphasized-texticon-icon-color-disabled: GrayText;
    --spectrum-actionbutton-m-emphasized-texticon-icon-color-hover: ButtonText;
    --spectrum-actionbutton-m-emphasized-texticon-icon-color-key-focus: ButtonText;
    ...
    --spectrum-actionbutton-m-emphasized-textonly-background-color: ButtonFace;
    --spectrum-actionbutton-m-emphasized-textonly-background-color-disabled: ButtonFace;
    --spectrum-actionbutton-m-emphasized-textonly-background-color-down: ButtonFace;
    --spectrum-actionbutton-m-emphasized-textonly-background-color-hover: ButtonFace;
    --spectrum-actionbutton-m-emphasized-textonly-background-color-key-focus: ButtonFace;
    ...
    --spectrum-actionbutton-m-emphasized-textonly-border-color: ButtonText;
    --spectrum-actionbutton-m-emphasized-textonly-border-color-disabled: GrayText;
    --spectrum-actionbutton-m-emphasized-textonly-border-color-down: ButtonText;
    --spectrum-actionbutton-m-emphasized-textonly-border-color-hover: ButtonText;
    --spectrum-actionbutton-m-emphasized-textonly-border-color-key-focus: ButtonText;
    ...
    --spectrum-actionbutton-m-emphasized-textonly-hold-icon-color: ButtonText;
    --spectrum-actionbutton-m-emphasized-textonly-hold-icon-color-disabled: GrayText;
    --spectrum-actionbutton-m-emphasized-textonly-hold-icon-color-down: ButtonText;
    --spectrum-actionbutton-m-emphasized-textonly-hold-icon-color-hover: ButtonText;
    --spectrum-actionbutton-m-emphasized-textonly-hold-icon-color-key-focus: ButtonText;
    --spectrum-actionbutton-m-emphasized-textonly-hold-icon-color-selected: HighlightText;
    --spectrum-actionbutton-m-emphasized-textonly-text-color: ButtonText;
    --spectrum-actionbutton-m-emphasized-textonly-text-color-disabled: GrayText;
    --spectrum-actionbutton-m-emphasized-textonly-text-color-down: ButtonText;
    --spectrum-actionbutton-m-emphasized-textonly-text-color-hover: ButtonText;
    --spectrum-actionbutton-m-emphasized-textonly-text-color-key-focus: ButtonText;
    ...
    --spectrum-actionbutton-m-quiet-textonly-border-size-key-focus: 3px;
  }
